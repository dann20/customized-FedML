class MyMessage(object):
    ...
    MSG_ARG_KEY_CONTROL_VARIATES = "control_variates"
    MSG_ARG_KEY_DELTA_MODEL_PARAMS = "delta_model_params"
    MSG_ARG_KEY_DELTA_CONTROL_VARIATES = "delta_control_variates"
